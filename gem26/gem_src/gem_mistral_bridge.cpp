...
#define __PYX_HAVE__gem_mistral_bridge
#define __PYX_HAVE_API__gem_mistral_bridge
/* Early includes */
#include <string.h>
#include <stdlib.h>
#ifdef _OPENMP
...
static const char* const __pyx_f[] = {
  "gem_src/gem_mistral_bridge.pyx",
};
...
/* Module declarations from "gem_mistral_bridge" */
__PYX_EXTERN_C char *call_mistral_native(char *, char *, char *); /*proto*/
__PYX_EXTERN_C char *call_yfinance_ticker(char *); /*proto*/
__PYX_EXTERN_C char *call_tradingview_high_yield(char *); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "gem_mistral_bridge"
extern int __pyx_module_is_main_gem_mistral_bridge;
int __pyx_module_is_main_gem_mistral_bridge = 0;

/* Implementation of "gem_mistral_bridge" */
...
#define __pyx_n_u_currentPrice __pyx_string_tab[26]
#define __pyx_n_u_d __pyx_string_tab[27]
#define __pyx_n_u_data __pyx_string_tab[28]
#define __pyx_n_u_dayHigh __pyx_string_tab[29]
#define __pyx_n_u_dayLow __pyx_string_tab[30]
#define __pyx_n_u_desc __pyx_string_tab[31]
#define __pyx_n_u_description __pyx_string_tab[32]
#define __pyx_n_u_dividend_yield_recent __pyx_string_tab[33]
...
char *call_mistral_native(char *__pyx_v_api_key, char *__pyx_v_model, char *__pyx_v_prompt) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("call_mistral_native", 0);

  /* "gem_mistral_bridge.pyx":10
 *     cdef char* c_string
 *     cdef char* c_err
 *     try:             # <<<<<<<<<<<<<<
 ...
 *             return NULL
*/
      __pyx_t_6 = PyObject_Length(__pyx_v_byte_str); if (unlikely(__pyx_t_6 == ((Py_ssize_t)-1))) __PYX_ERR(0, 21, __pyx_L3_error)
      __pyx_v_c_string = ((char *)malloc((__pyx_t_6 + 1)));

      /* "gem_mistral_bridge.pyx":22
 * 
 *         c_string = <char*>malloc(len(byte_str) + 1)
 *         if c_string == NULL:             # <<<<<<<<<<<<<<
 *             return NULL
 ...
 *             return NULL
*/
        __pyx_t_6 = __Pyx_PyBytes_GET_SIZE(__pyx_v_err_msg); if (unlikely(__pyx_t_6 == ((Py_ssize_t)-1))) __PYX_ERR(0, 28, __pyx_L15_error)
        __pyx_v_c_err = ((char *)malloc((__pyx_t_6 + 1)));

        /* "gem_mistral_bridge.pyx":29
 *         err_msg = ("Error: " + str(e)).encode('utf-8')
 *         c_err = <char*>malloc(len(err_msg) + 1)
 *         if c_err == NULL:             # <<<<<<<<<<<<<<
 *             return NULL
...
char *call_yfinance_ticker(char *__pyx_v_symbol) {
  char *__pyx_v_c_string;
  char *__pyx_v_c_err;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("call_yfinance_ticker", 0);

  /* "gem_mistral_bridge.pyx":37
 *     cdef char* c_string
 *     cdef char* c_err
 *     try:             # <<<<<<<<<<<<<<
 ...
 * 
*/
      __pyx_t_5 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_yfinance, 0, 0, NULL, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 38, __pyx_L3_error)
      __pyx_t_4 = __pyx_t_5;
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_v_yf = __pyx_t_4;
      __pyx_t_4 = 0;

      /* "gem_mistral_bridge.pyx":39
 *     try:
 *         import yfinance as yf
 *         import json             # <<<<<<<<<<<<<<
 * 
...
*/
      __pyx_t_5 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_json, 0, 0, NULL, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 39, __pyx_L3_error)
      __pyx_t_4 = __pyx_t_5;
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_v_json = __pyx_t_4;
      __pyx_t_4 = 0;

      /* "gem_mistral_bridge.pyx":41
 *         import json
 * 
 *         ticker = yf.Ticker(symbol.decode('utf-8'))             # <<<<<<<<<<<<<<
 *         info = ticker.info
 * 
*/
      __pyx_t_6 = __pyx_v_yf;
      __Pyx_INCREF(__pyx_t_6);
      __pyx_t_7 = __Pyx_ssize_strlen(__pyx_v_symbol); if (unlikely(__pyx_t_7 == ((Py_ssize_t)-1))) __PYX_ERR(0, 41, __pyx_L3_error)
      __pyx_t_8 = __Pyx_decode_c_string(__pyx_v_symbol, 0, __pyx_t_7, NULL, NULL, PyUnicode_DecodeUTF8); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 41, __pyx_L3_error)
      __Pyx_GOTREF(__pyx_t_8);
      __pyx_t_9 = 0;
      {
        PyObject *__pyx_callargs[2] = {__pyx_t_6, __pyx_t_8};
        __pyx_t_4 = __Pyx_PyObject_FastCallMethod((PyObject*)__pyx_mstate_global->__pyx_n_u_Ticker, __pyx_callargs+__pyx_t_9, (2-__pyx_t_9) | (1*__Pyx_PY_VECTORCALL_ARGUMENTS_OFFSET));
 ...
 *         c_string = <char*>malloc(len(byte_str) + 1)
*/
      __pyx_t_8 = __pyx_v_response_str;
      __Pyx_INCREF(__pyx_t_8);
      __pyx_t_9 = 0;
      {
...
char *call_tradingview_high_yield(char *__pyx_v_type) {
  char *__pyx_v_c_string;
  char *__pyx_v_c_err;
...
static int __pyx_pymod_exec_gem_mistral_bridge(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_gem_mistral_bridge},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_gem_mistral_bridge(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_gem_mistral_bridge(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_gem_mistral_bridge(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'gem_mistral_bridge' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "gem_mistral_bridge" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_gem_mistral_bridge", 0);
  ...
  if (__pyx_module_is_main_gem_mistral_bridge) {
    if (PyObject_SetAttr(__pyx_m, __pyx_mstate_global->__pyx_n_u_name_2, __pyx_mstate_global->__pyx_n_u_main) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "gem_mistral_bridge")) {
      if (unlikely((PyDict_SetItemString(modules, "gem_mistral_bridge", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init gem_mistral_bridge", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init gem_mistral_bridge");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
